...
module.exports = function (CodeMirror) {
  ...
  function puncType(type) {
    return !type ? undefined : /\bpunctuation\b/.test(type) ? type : undefined
  }
  ...
  cmds.smartBackspace = function (cm) {
    if (cm.somethingSelected()) return cm.execCommand('delCharBefore')
  ...
  return (keyMap.sublime = mac ? keyMap.macSublime : keyMap.pcSublime)
}
